        ...
        <div id="primary" class="content-area">
          ...
          ?>
            ...
            <?php while ( have_posts() ) : the_post(); ?>
              ...
              <a href="<?=get_page_link(80)?> ">Cliquez ici</a> Pour retourner sur votre compte
            <?php endwhile; ?>
            <form action="offre-pdf" method="post">
              <input type="hidden" name="post_id" value="<?=$_POST['post_id']?>">
              <button class="btn btn-primary" type="submit" role="button" target="_blank"> Telecharger un PDF </button>
            </form>
