            ...
            <?php while ( have_posts() ) : the_post(); ?>
              <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="text-center" id="btn-offre"><a href="mes-offres-dexperiences" class="btn btn-default btn-lg" role="button"><H2>Mes Offres d'Experiences</H2>Pour consulter, créer, modifier ou supprimer des offres</a></div>
                </div>
                <div class="logo-upload col-lg-4 ">
                  ...
                  ?>
                  <br><button id="aShowForm" class="btn btn-primary"> Charger/modifier votre logo </button>
