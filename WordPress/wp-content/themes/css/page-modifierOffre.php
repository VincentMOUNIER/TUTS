<?php /* Template Name: Modifier Offre */ ?>
<?php if ( !is_user_logged_in() || $_GET['updated'] == "true") {
  wp_redirect( get_permalink( $post->post_parent )."?updated=true"); exit;
}   // Si l'utilisateur n'est pas authentifié, il sera renvoyé ou s'il vient de mettre à jour
?>
<?php acf_form_head(); ?>
<?php get_header('aide'); ?>
    ...
    <div class="col-lg-8 contenu texte_contenu">
        ...
        <?php if (have_posts()) : ?>
          ...
          <?php while ( have_posts() ) : the_post(); ?>
            ...
            // Je pense et c'est sûr, qu'il va falloir mettre, changer tous les id field group
            // le id est trouvable dans l'url lorsqu'on edit un field group dans le back office de WP et le menu d'ACF
            acf_form(array(
          'post_id'	=> $_POST['post_id'],
          'field_groups'	=> array( 136,167),
          'submit_value'	=> 'Modifier mon offre',
